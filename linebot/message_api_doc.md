...
ユーザーIDアップロード用のオーディエンスにユーザーIDを追加する際に、[プライバシーポリシー（2022年3月改定）](https://guide.line.me/privacy-policy_update/2022/0001/?lang=ja-jp)に同意していないユーザーのユーザーIDが含まれている場合、未同意のユーザーは無視され同意済みのユーザーのみが追加されます。
